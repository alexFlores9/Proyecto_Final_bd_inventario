 ...
 * @author PC
 */
@WebServlet(urlPatterns = {"/pdfProducto"})
public class pdfProducto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            try{
              ...
              par2.add(new Phrase("Tabla Producto", fondescrip));
              ...
              PdfPCell celda1 = new PdfPCell (new Paragraph("id_producto", FontFactory.getFont("Arial", 12, Font.BOLD, BaseColor.BLACK)));
              PdfPCell celda2 = new PdfPCell (new Paragraph("nom_producto", FontFactory.getFont("Arial", 12, Font.BOLD, BaseColor.BLACK)));
              ...
              PdfPCell celda5 = new PdfPCell (new Paragraph("unidad_de_medida", FontFactory.getFont("Arial", 12, Font.BOLD, BaseColor.BLACK)));
              PdfPCell celda6 = new PdfPCell (new Paragraph("estado_producto", FontFactory.getFont("Arial", 12, Font.BOLD, BaseColor.BLACK)));
              PdfPCell celda7 = new PdfPCell (new Paragraph("categoria", FontFactory.getFont("Arial", 12, Font.BOLD, BaseColor.BLACK)));
              PdfPCell celda8 = new PdfPCell (new Paragraph("desc_producto", FontFactory.getFont("Arial", 12, Font.BOLD, BaseColor.BLACK)));
              PdfPCell celda9 = new PdfPCell (new Paragraph("fecha_entrada", FontFactory.getFont("Arial", 12, Font.BOLD, BaseColor.BLACK)));
