...
public class Producto {
    ...
    public Producto(int id_producto, String nom_producto, double stock, double precio, String unidad_de_medida, int estado_producto, int categoria, String des_producto, Date fecha_entrada) {
